...
setup_file() {
  ...
  export TRIVY_DB_REPOSITORY=ghcr.io/${owner}/trivy-db:latest
  export TRIVY_JAVA_DB_REPOSITORY=ghcr.io/${owner}/trivy-java-db:latest
  export TRIVY_POLICY_BUNDLE_REPOSITORY=ghcr.io/${owner}/trivy-checks:latest
}
