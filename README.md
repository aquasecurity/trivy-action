  ...
  build:
    ...
    steps:
      ...
      - name: Run Trivy vulnerability scanner
        ...
        with:
          images-refs: "docker.io/my-organization/my-app:${{ github.sha }}"
          format: "table"
          exit-code: "1"
          ignore-unfixed: true
  ...
  build:
    ...
    steps:
      ...
      - name: Run Trivy vulnerability scanner
        uses: aquasecurity/trivy-action@master
        with:
          images-refs: "aws_account_id.dkr.ecr.region.amazonaws.com/imageName:${{ github.sha }}"
          format: "sarif"
          output: "trivy-results.sarif"
        env:
...
| `images-refs`     | String  |                                    | Image reference, e.g. `alpine:3.10.2`                                    |
