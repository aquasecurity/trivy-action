...
* [Usage](#usage)
  ...
  * [Scan CI Pipeline (w/ Trivy Config)](#scan-ci-pipeline-w-trivy-config)
    * [Order of preference for options](#order-of-preference-for-options)
  * [Cache](#cache)
    * [Disabling caching](#disabling-caching)
    * [Updating caches in the default branch](#updating-caches-in-the-default-branch)
  * [Trivy Setup](#trivy-setup)
    * [Setting up Trivy Manually](#setting-up-trivy-manually)
    * [Skipping Setup when Calling Trivy Action multiple times](#skipping-setup-when-calling-trivy-action-multiple-times)
    * [Use non-default token to install Trivy](#use-non-default-token-to-install-trivy)
...
* [GITHUB_TOKEN authentication, add only if you're not going to use a PAT](#github_token-authentication-add-only-if-youre-not-going-to-use-a-pat)
